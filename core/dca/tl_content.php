 ...
 */
 ...
 foreach ($palettes as $p => $str) {
 	 $pallete_ftc = str_replace("{type_legend}","{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc,data_attr_ftc;{type_legend}",$str);
...
$palettesSize=count($palettes)-1;
 $default = '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc,data_attr_ftc;{type_legend},type,headline;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop';
//add palettes for contentelements
array_insert($GLOBALS['TL_DCA']['tl_content']['palettes'], $palettesSize, array
(
	'orbit'        => '{type_legend},type,headline;{source_legend},multiSRC,sortBy,useHomeDir;{image_legend},size,numberOfItems;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'orbit_start'        => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'orbit_start_inside'        => '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'orbit_stop'        => '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'orbit_stop_inside'        => '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'clearing'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{source_legend},multiSRC,sortBy,useHomeDir;{image_legend},size,perRow,perPage,numberOfItems;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'button_ftc'            => '{type_legend},type,btn_name,cta_href,use_reveal;{button_legend},btn_size,btn_styles;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space',
	'button_bar_start_ftc'            => '{type_legend},type,headline;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space',
	'button_bar_stop_ftc'            => '{type_legend},type',
	'button_group'            => '{type_legend},type;{dropdown_legend},list_links;{button_legend},btn_size,btn_styles;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'dropdown_buttons'            => '{type_legend},type,btn_name;{dropdown_legend},list_links,drop_align;{button_legend},btn_size,btn_styles,btn_split,btn_hover;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'dropdown_buttons_content_start'            =>'{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,btn_name,drop_align;{button_legend},btn_size,btn_styles,btn_split,btn_hover;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	

	'joyride'           => '{type_legend},type;{joyride_legend},joyride;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'alert_box'            => '{type_legend},type;{alert_legend},alert_kind,alert_style,alert_txt;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'reveal_modal_start'            =>  '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'reveal_modal_stop'            => '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	

	'row_start'        => '{type_legend},type,headline,cssID,row_data_attr_ftc',
	'row_end'        => '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'headline_ftc'            => $default,
	'magellan_stop'            => $default,
	'magellan_nav'            => '{type_legend},type;{magellan_legend},magellan_nav;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',

	'blockquote'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{blockquote_legend},blockquote,cite;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'vcard'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{vcard_legend},vcard;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'list_ftc'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{list_legend},listtype,listitems,list_style_type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'def_list'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{list_legend},def_list;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'progress_bar'            => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,progress_size,btn_styles;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'tab_ftc_start'  =>  '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{nav_legend},tabs_nav,tabs_align;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop' ,
	'tab_ftc_stop'   => '{type_legend},type',
	'tab_ftc_start_inside'  => '{type_legend},type,headline,cssID',
	'tab_ftc_stop_inside'   => '{type_legend},type',
	
	'acc_ftc_start'  =>  $default ,
	'acc_ftc_stop'   => '{type_legend},type',
	'acc_ftc_start_inside'  => '{type_legend},type,headline,cssID',
	'acc_ftc_stop_inside'   => '{type_legend},type',
	'price_table'        => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{table_legend},price_table,cta_href;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	
	'flex_video'        => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{video_legend},use_youtube,vimeo,own_src;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
	'placeholder_image'                       => '{ftc_legend},small_ftc,large_ftc,float_ftc,align_ftc;{type_legend},type,headline;{placeholder_legend},is_bw,stamp,topic;{image_legend},alt,title,size,imagemargin,imageUrl,caption;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space;{invisible_legend:hide},invisible,start,stop',
