...
abstract class Hybrid extends \Frontend
{
	...
	public function __construct($objElement, $strColumn='main')
	{
		...
		//FTC Classes 
		$ftc_align= $this->splitArr($objElement->align_ftc);
		$ftc_data_attr = $this->splitArr($objElement->data_attr_ftc);
		$ftc_classes = $objElement->small_ftc.' '.$objElement->large_ftc.' '.$objElement->float_ftc.' '.$ftc_align.' columns';
		$this->data_attr = $ftc_data_attr;
		$this->ftc_classes = $ftc_classes;
