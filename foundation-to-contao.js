...
$(document).ready(function() {
	...
	// #6 Diese Funktion ist spezifisch für das Theme The Macarons. Der Footer-Inhalt ist 3-Spaltig
	...
	// #7 Bild im Bildinhaltselement mittig setzen
	...
	// #10 Produktreaderseite Footerkorrektur + Productlist
	// wahrscheinlich verträgt sich das isotope.js auf den shop-seiten nicht mit diesem
	...
	var _productlist_wrapped = $('.mod_iso_productlist').parent().attr('class');

	if (_productlist_wrapped !== undefined) {
		var _vergleich_productlistwrap = _productlist_wrapped.indexOf('row');

		if (_vergleich_productlistwrap > -1) {
			$('.mod_iso_productlist').wrap('<div class="mod_article small-12 large-12">');
		}
	}
